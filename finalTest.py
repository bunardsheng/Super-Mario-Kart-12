...
def gameMode_redrawAll(app, canvas):
    ...
    #     pt1, pt2, pt3, pt4 = convertBuildingR(app, start, width, height, app.slopeR)

    #     canvas.create_polygon(pt1, pt2, pt3, pt4, fill = fill, width = 1.1, outline = 'black')
    #     canvas.create_rectangle(pt1, app.width, pt4[1], fill = fill+'4', width = 1.1, outline = 'black')
    #     canvas.create_polygon(pt1, pt2, app.width, pt2[1], app.width, pt1[1], fill = fill+'3', outline = 'black')




def convertBuildingL(app, start, width, height, slope):
    gap = 20
...
def buildingTurnL(app, canvas):
     for i in range(len(app.cubesL)):
        ...
        pt1, pt2, pt3, pt4 = convertBuildingL(app, start, width, height, app.slopeL)
...
def convertBuildingR(app, start, width, height, slope):
    gap = 20 
